...
public class ReviewClientPersistence {
    ...
    public ReviewClientPersistence(User currentUser) {
    ...
    public void setReviewDocumentSections(Response<ReviewDocumentRequest> response) {
        ...
        reviewCollector = new ReviewCollector(currentUser, new ReviewDocumentSectionsManager(reviewDocumentSections));
    }

    public ReviewHistoricalRequest getInitialRequest() {
        return new ReviewHistoricalRequest(currentUser, reviewCollector.getFirstNotClosedReviewIndex());
    }
